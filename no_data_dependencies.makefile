...
##############################################################################-  
# This makefile will have the same effect as the more explicit makefile. It can be executed by setting your wd to this directory and typing into the terminal without the "#"

# make -f makefile_concise.makefile
